...
/**
 *  `Airdrop` contracts provide a lightweight and easy to use mechanism
 *  to drop tokens.
 *
...
interface IAirdropERC20Claimable {
     ...
     *                                        allowlist can claim.
     */
    function claim(address receiver, uint256 quantity, bytes32[] calldata proofs, uint256 proofMaxQuantityForWallet)
        external;
}
